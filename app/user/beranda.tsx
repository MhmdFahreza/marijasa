...
export default function Beranda() {
  ...
  return (
    <>
      {/* CONTENT 1: hero dengan background lines */}
      <BackgroundLines
      ...
      >
        ...
        <p className="max-w-xl mx-auto text-sm md:text-lg text-neutral-700 dark:text-neutral-400 text-center relative z-20">
          Dapatkan solusi jasa rumah tangga yang aman, terjangkau, dan
          terpercaya. Temukan penyedia jasa terbaik untuk Anda dengan mengeklik
          tombol di bawah.
        </p>
        ...
        <motion.button
          ref={btnRef}
          style={{ x, y, scale }}
          className="mt-6 md:mt-8 shadow-[inset_0_0_0_2px_#616467] 
        text-black dark:text-neutral-200
        px-5 py-2.5 md:px-7 md:py-3
        text-sm md:text-base
        rounded-full tracking-wide md:tracking-widest
        bg-transparent hover:bg-[#616467] hover:text-white
      ...
      {/* CONTENT 2: apple cards di bawah background lines */}
