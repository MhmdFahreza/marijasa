...
export default function SiteFooter() {
    return (
        <div className="w-full -mb-8 sm:-mb-6 md:-mb-4">
                ...
                <div className="max-w-[85rem] mx-auto">
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                        <div className="col-span-2 md:hidden lg:col-span-1 lg:block mb-6 lg:mb-0">
                            <Link
                                className="flex-none font-semibold text-xl text-[#7CE0A8] dark:text-[#7CE0A8] focus:outline-hidden focus:opacity-80"
                                href="#"
                                aria-label="Brand"
                            >
                                MARIJASA
            ...
            <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] bg-[#7CE0A8] py-5 mb-0" style={{ marginBottom: 0 }}>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-4 w-full md:w-auto md:ml-auto">
                            ...
                            <div className="flex items-center justify-between md:justify-end gap-4 w-full md:w-auto">
                                <div className="flex gap-2 sm:gap-4 text-xs sm:text-sm">
                                    <Link className="text-white hover:text-gray-100 focus:outline-hidden whitespace-nowrap" href="#">
                                        Syarat &amp; Ketentuan
                                    </Link>
                                    <Link className="text-white hover:text-gray-100 focus:outline-hidden whitespace-nowrap" href="#">
                                        Kebijakan Privasi
                                ...
                                <div className="flex gap-2 sm:gap-4">
                                    <Link className="inline-block text-white hover:text-gray-100 focus:outline-hidden" href="#">
