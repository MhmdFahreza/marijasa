...
export default function SiteFooter() {
    return (
        <>
            ...
            <footer className="relative mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
                ...
                <div className="pt-5 mt-5 border-t border-gray-200 dark:border-neutral-800">
                    <div className="sm:flex sm:justify-between sm:items-center">
                        <div className="flex flex-wrap items-center gap-3"></div>

                        <div className="flex flex-wrap justify-between items-center gap-3">
                            <div className="mt-3 sm:hidden">
                                <Link className="flex-none font-semibold text-xl text-black dark:text-white focus:outline-hidden focus:opacity-80" href="#" aria-label="Brand">
                                    MARIJASA
                                </Link>
                                <p className="mt-1 text-xs sm:text-sm text-gray-600 dark:text-gray-400">© 2025 Preline Labs.</p>
                            </div>

                            <div className="flex items-center gap-4">
                                <div className="space-x-4 text-sm">
                                    <Link className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 focus:outline-hidden" href="#">
                                        Syarat &amp; Ketentuan
                                    </Link>
                                    <Link className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 focus:outline-hidden" href="#">
                                        Kebijakan Privasi
                                ...
                                <div className="space-x-4">
                                    <Link className="inline-block text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 focus:outline-hidden" href="#">
