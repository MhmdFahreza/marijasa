...
// Voice Message Player Component - FIXED (gunakan warna hijau)
            ...
            return (
              <div
                ...
                className={`flex-1 rounded-full transition-colors duration-100 ${
                  isActive
                    ? isUser ? "bg-white" : "bg-green-300"
                    : isUser ? "bg-green-100/50" : "bg-gray-300"
                }`}
                style={{
                  height: `${height}%`,
                  minHeight: "6px",
    ...
    >
      <button
        ...
        className={`h-10 w-10 rounded-full flex items-center justify-center flex-shrink-0 transition-all ${
          isUser ? "bg-white/20 hover:bg-white/30" : "bg-green-500 hover:bg-green-600"
...
// Media Message Component - FIXED (gunakan warna hijau)
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-xl border ${
        isUser ? "border-green-200" : "border-gray-200"
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Button variant="ghost" size="icon" onClick={() => router.push("/")} className="rounded-full hover:bg-gray-100">
                <ArrowLeft className="h-5 w-5" />
              </Button>
              <div>
                <h1 className="text-xl font-bold text-gray-800">Chat Customer</h1>
                <p className="text-sm text-gray-600">Percakapan dengan vendor</p>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Badge className="bg-green-500">
                    {chatList.filter(s => s.userUnreadCount > 0).length} baru
                  </Badge>
                </div>
              </div>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="relative">
                        <Avatar className="h-10 w-10">
                          <AvatarImage src={chat.mitraAvatar} />
                          <AvatarFallback>
                            {(chat.mitraName || "V").substring(0, 2).toUpperCase()}
                          </AvatarFallback>
                        </Avatar>
                        {chat.mitraOnline && (
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between">
                          <p className="text-xs text-gray-600 truncate pr-2">
                            {(chat.lastMessage || "").substring(0, 30) || "Mulai percakapan"}
                          </p>
            ...
            {!vendorId ? (
              <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
                ...
                <p className="text-gray-500 mb-6">
                  Pilih vendor dari daftar untuk memulai percakapan
                </p>
                <Button 
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <Avatar className="h-10 w-10 border-2 border-white shadow">
                        ...
                        <AvatarFallback>
                          {(vendorName || "V").substring(0, 2).toUpperCase()}
                        </AvatarFallback>
                      </Avatar>
                      <div>
                        <div className="flex items-center gap-2">
                    ...
                    {messages.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-gray-500">
                          Kirim pesan untuk memulai chat dengan {vendorName}
                        </p>
                      </div>
                    ) : (
                                ...
                                <div className={`relative ${isMedia || isVoice ? "" : isUser ? 'bg-gradient-to-r from-green-500 to-green-600 text-white rounded-2xl rounded-br-none shadow-lg px-4 py-3' : 'bg-white border shadow-sm rounded-2xl rounded-bl-none px-4 py-3'}`}>
                                  ...
                                  {!isMedia && !isVoice && (
                                    <div className={`flex items-center gap-1 mt-2 ${isUser ? 'justify-end' : 'justify-start'}`}>
                                      <span className={`text-xs ${isUser ? 'text-green-100' : 'text-gray-400'}`}>
                                  ...
                                  {!isMedia && !isVoice && (
                                    <div 
                                      className={`absolute bottom-0 w-3 h-3 ${isUser ? '-right-1 bg-green-500' : '-left-1 bg-white border-l border-b'}`} 
                                      style={{ 
                                        clipPath: isUser 
